...
const Overview = () => {
  ...
  return (
    <section>
      <h3
        className={`${outfit?.className} block text-center text-xl font-bold capitalize relative mb-4`}
        style={{
          color: colors?.accent,
        }}
      >
        Overview
        {/* Underline SVG */}
        <span className="block w-[80px] absolute -bottom-1 left-[50%] -translate-x-[50%]">
